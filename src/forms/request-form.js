        ...
        return (
            <div className="rf--form-elements">
                <ServicebotBaseForm
                    ...
                    svgIcon={`%3Csvg width='56px' height='56px' viewBox='0 0 56 56' version='1.1' xmlns='http://www.w3.org/2000/svg' xmlns:xlink='http://www.w3.org/1999/xlink'%3E%3C!-- Generator: Sketch 49 (51002) - http://www.bohemiancoding.com/sketch --%3E%3Ctitle%3Esb-icon-success%3C/title%3E%3Cdesc%3ECreated with Sketch.%3C/desc%3E%3Cdefs%3E%3C/defs%3E%3Cg id='sb-icon-success' stroke='none' stroke-width='1' fill='none' fill-rule='evenodd'%3E%3Cg id='Group'%3E%3Ccircle id='Oval' stroke='%232AC09D' stroke-width='0.699999988' fill='%2350CDAB' cx='28' cy='28' r='28'%3E%3C/circle%3E%3Cpath d='M17.5,27.3 L23.090905,36.6595151 C23.4874182,37.3233022 24.3469615,37.5399706 25.0107487,37.1434574 C25.17712,37.0440756 25.3210464,36.9112352 25.4334168,36.7533457 L38.6378803,18.2' id='Path-5' stroke='%23FFFFFF' stroke-width='4.19999993' stroke-linecap='round'%3E%3C/path%3E%3C/g%3E%3C/g%3E%3C/svg%3E`}
