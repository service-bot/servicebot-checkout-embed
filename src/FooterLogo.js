...
const FooterLogo = () => {
	return (
		<div style={containerStyle} className={`pricing-generated-by`}>
			<a
				style={linkStyle}
				target="_blank"
				rel="noopener"
				href="https://servicebot.io?embed=tiers"
				className="__link"
			>
				<span style={textStyle} className="__text">
					Powered by
				</span>
				<img
					style={style}
